const projectsArr = [
	...
	// 	description: "A google chrome extension for swipe gestures in the browser. Hold down right mouse button to initiate a command.",
	// 	techDescription: "Vanilla Javascript, and the Google Extension API.",
	// 	githubLink: "",
	// 	link: ""
	// },
	// {
	// 	name: 'Rock, Paper, Scissor multiplayer',
	// 	pic: "/projects/undraw_rps.svg",
	// 	description: "Rock, Paper, Scissor as a multiplayer game.",
	// 	techDescription: "Frontend is HTML, CSS and Javascript. Backend is in Node JS and Socket.IO. Demo is deployed on Heroku.",
	// 	githubLink: "",
	// 	link: ""
	// },
]
